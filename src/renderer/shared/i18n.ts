...
const messages = {
    ...
    'fpsPatch.description': 'Скачивает патч и устанавливает его в Data/ruRU выбранного клиента.',
    ...
    'fpsPatch.description': 'Downloads the patch and installs it into Data/ruRU of the selected client.',
